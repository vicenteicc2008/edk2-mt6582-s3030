#/** @file
#
# Copyright (c) 2021, Vicente Iñaki Cortes Cortes. All rights reserved.<BR>
#
#**/
...
################################################################################
[Defines]
  PLATFORM_NAME                  = MT6582Pkg
  PLATFORM_GUID                  = 91fa6c28-33df-46ac-aee6-292d6811ea31
  PLATFORM_VERSION               = 0.1
  DSC_SPECIFICATION              = 0x00010005
  OUTPUT_DIRECTORY               = Build/MediatekPkg/Msm8960Pkg
  SUPPORTED_ARCHITECTURES        = ARM
  BUILD_TARGETS                  = DEBUG|RELEASE
  SKUID_IDENTIFIER               = DEFAULT
  FLASH_DEFINITION               = MT6582Pkg/MT6582Pkg.fdf
...
!endif
  ...
  SerialPortLib                    |    MT6582Pkg/Library/MsmSerialPortLib/MsmSerialPortLibWithoutInit.inf
  MsmSharedLib                     |    MT6582Pkg/Library/MsmSharedLib/MsmSharedLib.inf
  MsmClockLib                      |    MT6582Pkg/Library/MsmClockLib/MsmClockLib.inf
  MsmSSBILib                       |    MT6582Pkg/Library/MsmSSBILib/MsmSSBILib.inf
  RealTimeClockLib                 |    MT6582Pkg/Library/MsmPM8921RealTimeClockLib/MsmPM8921RealTimeClockLib.inf
  
  
  TimerLib                         |    MT6582Pkg/Library/MsmTargetTimerLib/MsmTargetTimerLib.inf
  MsmTargetLib                     |    MT6582Pkg/Library/MsmTargetLib/MsmTargetLib.inf
  MsmTargetGpioLib                 |    MT6582Pkg/Library/MsmTargetGpioLib/MsmTargetGpioLib.inf
  EfiResetSystemLib                |    MT6582Pkg/Library/MsmTargetResetSystemLib/MsmTargetResetSystemLib.inf
  MsmTargetClockLib                |    MT6582Pkg/Library/MsmTargetClockLib/MsmTargetClockLib.inf
  MsmTargetMmcLib                  |    MT6582Pkg/Library/MsmTargetMmcLib/MsmTargetMmcLib.inf
  MsmTargetI2C                     |    MT6582Pkg/Library/MsmTargetI2C/MsmTargetI2C.inf
...
[LibraryClasses.common.DXE_DRIVER]
  ...
  MsmPM8921Lib                     |    MT6582Pkg/Library/MsmPM8921Lib/MsmPM8921Lib.inf
...
#
  ...
  gArmPlatformTokenSpaceGuid.PcdFirmwareVendor                |"Mediatek MT6582 by Vicente Iñaki Cortes Cortes"
...
#      NULL|IntelFrameworkModulePkg/Library/LzmaCustomDecompressLib/LzmaCustomDecompressLib.inf
  ...
  #(DXE_DRIVER)
  MT6582Pkg/Dxe/TimerDxe/TimerDxe.inf
  
  #(DXE_DRIVER)
  MT6582Pkg/Dxe/PM8921Dxe/PM8921Dxe.inf
  
  #(DXE_DRIVER)
  MT6582Pkg/Dxe/DisplayDxe/DisplayDxe.inf
  
  #(DXE_DRIVER)
  MT6582Pkg/Bds/Bds.inf
  ArmPlatformPkg/Bds/Bds.inf
  
  #(DXE_DRIVER)
  MT6582Pkg/Dxe/MMCHSDxe/MMCHS.inf
